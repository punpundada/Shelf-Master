...
SELECT token_hash, user_id, expires_at FROM reset_password where token_hash = $1
`

func (q *Queries) GetResetPasswordFromTokenHash(ctx context.Context, tokenHash pgtype.Text) (ResetPassword, error) {
...
INSERT INTO reset_password(token_hash,user_id,expires_at) values($1,$2,$3) RETURNING token_hash, user_id, expires_at
`
...
func (q *Queries) SavePasswordRestToken(ctx context.Context, arg SavePasswordRestTokenParams) (ResetPassword, error) {
